...
const SkillsContent = () => {
  ...
  const hoverStylesForContentDiv =
    "bg-[#FAFAFA] transition-all duration-300 hover:drop-shadow-2xl hover:shadow-2xl hover:scale-105 flex flex-col items-center justify-end w-full";
  ...
  return (
    <div className="bg-[#FAFAFA] lg:w-full shadow-lg drop-shadow-md p-1  lg:mb-2 ">
      <div className="p-5 bg-[#FAFAFA] flex flex-col items-center gap-3 lg:mb-2 ">
        {/* intro */}
        <div className="bg-[#FAFAFA] flex flex-col items-center w-full p-2 text-center">
          <h1 className="text-3xl font-bold">Skills & Vision</h1>
