...
const LeftSideBar = ({ handleSideBar, isSideBarClose }) => {
    ...
    <>
      ...
      <div className=" ">
        ...
        <div
          ...
          {/* divider */}
          <div
            className={`hidden sm:hidden md:hidden lg:block xl:block 2xl:block w-full h-1 rounded-t-lg ${
          ...
          {/*  */}
          <div
            className={`hidden sm:hidden md:hidden lg:flex xl:flex 2xl:flex p-0 xl:p-5 ${
          ...
          {/*  */}
          <div className="block sm:block md:block lg:hidden xl:hidden 2xl:hidden mx-8">
            <h1>Profiles</h1>
          </div>
          {/*  */}
          <div
            className={`hidden sm:hidden md:hidden lg:flex xl:flex 2xl:flex p-1 md:p-0 lg:p-5 xl:p-5 2xl:p-6 items-center justify-evenly gap-3 rounded-b-lg ${
  ...
  return (
    <div
      ...
      ${
        isSideBarClose
          ? "w-[50px] md:w-[48px] lg:w-[160px] xl:w-[160px] 2xl:w-[170px]"
      ...
      <div
        className={`hidden sm:hidden md:hidden lg:flex xl:flex 2xl:flex justify-between items-center gap-3 lg:justify-evenly lg:mt-2 ${
          isSideBarClose
